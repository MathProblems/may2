...
def make_eq(q,a,equations):
    ...
    pickle.dump(bigtexamples,open('data/'+sys.argv[1][-1]+".local.training.2",'wb'))
...
#eqsdir = "data.ixl.curated"
#eqsdir = "data.emnlp.curated"
#eqsdir = "data.emnlp.reduced"
#eqsdir = "data.emnlp.reduced.plus"
#eqsdir = "data.IXL-v3.old"
#eqsdir = "data.IXL-v2.old"
#eqsdir = "jData"
#eqsdir = 'data.full.out'
#eqsdir = 'data.full.bugfix.oldILP.out'
#eqsdir = 'data.full.6.17.out'
eqsdir = 'data.6.17.2.out'
#eqsdir = 'IXL2.out'
#eqsdir = 'IXL3.out'
#eqsdir = 'data.full.notypes'
